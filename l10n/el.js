OC.L10N.register(
    ...
    "Install it from the app store." : "Εγκατάσταση από την αγορά εφαρμογών.",
    "If the installation from the app store fails, you can still do that manually using this command:" : "Εάν η εγκατάσταση από την αγορά εφαρμογών αποτύχει, μπορείτε να το κάνετε χειροκίνητα με την εντολή:",
