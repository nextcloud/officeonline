OC.L10N.register(
    ...
    "Collabora Online requires a seperate server acting as a WOPI-like Client to provide editing capabilities." : "在线协作应用需要一台单独的服务器作为WOPI客户端以提供编辑功能。",
    ...
    "You can use a demo server provided by Collabora and other service providers for giving Collabora Online a try." : "您可以使用由Collabora及其他服务提供商提供的演示服务器来试用在线协作服务。",
    ...
    "Use Office Open XML (OOXML) instead of OpenDocument Format (ODF) by default for new files" : "默认使用Office Open XML (OOXML) 格式而不是OpenDocument Format (ODF) 格式创建新文件。",
