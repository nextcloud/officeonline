OC.L10N.register(
    ...
    "Show watermark for all shares" : "Afficher le filigrane pour tous les partages",
    "Show watermark for read only shares" : "Afficher le filigrane pour les partages en lecture seule",
    "Show watermark for all link shares" : "Affichier le filigrane pour tous les liens partagés",
    "Show watermark for download hidden shares" : "Afficher le filigrane pour télécharger les actions cachées",
    "Show watermark for read only link shares" : "Afficher le filigrane pour les liens en lecture seule",
    "Show watermark on link shares with specific system tags" : "Afficher le filigrane sur les partages de liens avec des balises système spécifiques",
    "Contact {0} to get an own installation." : "Contact {0} pour obtenir votre propre installation. ",
    ...
    "Built-in CODE Server is restarting, please wait." : "Le serveur CODE intégré redémarre, veuillez patienter.",
    "Error: Cannot find the AppImage, please reinstall the Collabora Online Built-in server." : "Erreur : Impossible de trouver l'AppImage, veuillez installer le serveur intégré Collabora Online à nouveau.",
